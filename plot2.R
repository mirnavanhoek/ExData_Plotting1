...
## Produce plot2.png with the required width and height
png("plot2.png", width=480, height=480)
plot(household$datetime,  household$Global_active_power, ylab="Global Active Power (kilowatts)", type="l", xlab="")
dev.off()
